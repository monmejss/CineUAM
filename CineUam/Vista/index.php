...
<body>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active d-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5>Cine UAM es todo lo que necesitas y más...</h5>
    ...
    <section class="cartelera_section layout_padding">
        <div class="container">
            <h2 class="section_heading">Cartelera de Cine</h2>
            <div class="row">
                <?php
                ...
                foreach ($funciones as $funcion) {
                    ...
                    echo "<p>" . $funcion->getHorario()->getFecha() . " - " . $funcion->getHorario()->getHoraInicio() . "</p>";
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <p>Disfruta de todos los alimentos y bebidas que tanto te encantan para vivir al máximo tu experiencia en nuestras salas.</p>
                        <a href="#">Comprar</a>
                    </div>
                </div>
            </div>
