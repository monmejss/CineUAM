...
<body>
    ...
    <!--Cartelera-->
    <!--AQUI LO DE CARTELERA-->
    <h1>Cartelera de Cine</h1>
    <div class="cartelera">
        <?php foreach ($funciones as $funcion): ?>
            <div class="funcion">
                <img src="<?php echo $funcion->getPelicula()->getImagen(); ?>" alt="<?php echo $funcion->getPelicula()->getNombre(); ?>">
                <h2><?php echo $funcion->getPelicula()->getNombre(); ?></h2>
                <p><?php echo $funcion->getPelicula()->getDescripcion(); ?></p>
                <p>Duración: <?php echo $funcion->getPelicula()->getDuracion(); ?> minutos</p>
                <p>Género: <?php echo $funcion->getPelicula()->getGenero(); ?></p>
                <p>Fecha: <?php echo $funcion->getHorario()->getFecha(); ?></p>
                <p>Hora: <?php echo $funcion->getHorario()->getHora(); ?></p>
                <p>Sala: <?php echo $funcion->getSala()->getTipo(); ?> - <?php echo $funcion->getSala()->getSucursal(); ?></p>
            </div>
        <?php endforeach; ?>
    </div>
    <!--End Cartelera-->
